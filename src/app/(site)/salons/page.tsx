export default function Salons() {
  return (
    <section className="sec-cont">
      <div className="salons sec-cont">
        <div className="undercategory">
          <h1 className="about-salons">Kort om våra salonger</h1>
          <nav className="sec">
            <ul className="movies-salon-list">
              <li className="movies-salon-element">
                <a href="/salon/a">Salong A</a>
              </li>
              <li className="movies-salon-element">
                <a href="/salon/b">Salong B</a>
              </li>
            </ul>
          </nav>
        </div>
        ...
        <p className="salon-text">
          När biografen invigdes fanns en salong med 350 platser, med vad man
          kan förmoda ganska begränsad sittkomfort. Detta ändrades efterhand och
          vid början av 2000-talet hade den siffran gått ned till 150 mycket
          skönare fåtöljer. Nu har den klassiska salongen 141 fantastiska
          fåtöljer på samma yta. Det ger fantastiskt benutrymme och den vackert
          svepande kurvan i golvet ger utmärkt sikt. Efterhand har tekniken för
          att visa film förfinats och när den digitala tekniken blev mogen var
